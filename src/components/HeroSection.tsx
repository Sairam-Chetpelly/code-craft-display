    ...
    >
      ...
      <div className="w-full max-w-screen-xl mx-auto px-6 md:px-10 relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          <AnimatedText className="mb-6" delay={200}>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight">
              <span className="block">Creating elegant</span>
              <span className="block mt-2 text-gradient">digital experiences</span>
            </h1>
          </AnimatedText>
          
          <AnimatedText className="max-w-2xl mx-auto mb-12" delay={300}>
          ...
          <AnimatedText className="flex flex-wrap gap-4 justify-center" delay={400}>
